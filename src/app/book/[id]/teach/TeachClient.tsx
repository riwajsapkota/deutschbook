        ...
        <div className="bg-white border border-gray-200 rounded-lg px-6 py-6 mb-6">
          ...
          <ReactMarkdown
            ...
            components={{
              ...
              th: ({ children }) => <th className="bg-gray-50 border border-gray-200 px-3 py-2 text-left font-medium text-blue-900">{children}</th>,
              td: ({ children }) => <td className="border border-gray-200 px-3 py-2 text-gray-900">{children}</td>,
